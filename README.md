...
1.	Events: The main piece of data. Events contain pre-defined jKool fields and can also contain your own custom fields (as snapshots and properties, explained below)
2.	Activities: A way of organizing events into groupings (categories)
3.	Snapshots: A way of organizing custom fields into groupings (categories)
4.	Properties: Your custom fields.
