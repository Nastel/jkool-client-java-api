 ...
 * "correlator id".
 * 
 * Although this example does not demonstrate it, snapshots could be added. 
...
public class DevOpsAppl1 {
	...
	public static void main(String[] args) {
		try
		{
			...
			Event event = new Event("05d537d1-6dd1-11e5-9767-600292390f02", 
					                                       // trackingId
	                ...
	                460,                                   // elapsedTimeUsec
	                "AMAZON ProductId=28372373 Title: Crash Proof: Author: Robert Prechter Jr.", 
	                                                       // msgText
	                74,                                    // msgSize
	                "none",                                // msgEncoding
			...
			event = new Event("05d537d2-6dd1-11e5-9767-600292390f02", 
	                ...
	                Arrays.asList("OrderId:123@1444318021796223@1"),       
	                                                        // Correlator Id.
	                "VALIDATE.ORDERS.QUEUE",                // resource
	                "text/plain",                           // msgMimeType
	                0,                                      // msgAge
	                null,                                   // exception
	                null,                                   // msgTag
