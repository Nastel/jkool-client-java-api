...
public class StreamAirlineData {
	...
	public static final Set<String> JKOOL_EVENT_FIELDS = new HashSet<String>(
	...
	public static void processFile(String fileName) {
		...
		try {
			...
			// Read the remaining lines. Store each line in a HashMap (key=field name value=field value). Store all
			// lines in a array of HashMaps.
			int eventNo = 0;
	...
	public static Long dateFromString(HashMap line, String timeType, String type) {
		try {
			...
			String stringDate = (String) line.get("Year") + "-"
					+ String.format("%02d", Integer.parseInt((String) line.get("Month"))) + "-"
					+ String.format("%02d", Integer.parseInt((String) line.get("DayofMonth")));
	...
	@SuppressWarnings({ "unchecked" })
	public static void setCommonFields(HashMap line, Event event, UUID parentTrackingId, List<Property> properties,
