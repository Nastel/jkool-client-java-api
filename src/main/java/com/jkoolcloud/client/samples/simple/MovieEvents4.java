...
/**************************************************************************************************************************
 * This example code uses the same data as the prior Movie example code. However, it also demonstrates how to make use of Snapshots. In this
 * example, snapshots are being used to capture the weather at the time the movie was playing.
 * 
